...
/**
 * @author prajjwol </br>
 * @description Rastrigin Function </br>
 *              MINRANGE = -5.12 </br>
 *              MAXRANGE = 5.12 </br>
...
public class RastriginFunction implements Function {
	...
	/**
	 * This function calculate the fitness value for Rastrigin Function
	 * 
	 * @param param
	...
	public float calcFitness(float[] param) {
		float result = 10.0f * DIMENSION;

		for (int i = 0; i < param.length; i++) {
			result += Math.pow(param[i], 2) - 10.0f * Math.cos(2 * Math.PI * param[i]);
		}
