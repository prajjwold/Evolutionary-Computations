...
public class DataRecorder {
	...
	public static void open() {
		try {
			...
			writer1.write("Dimension,Generations,AverageFitness,BestFitness\n");
	...
	public static void write1(int dimension,int generation, double avgFitness, double bestFitness) {
		writer1.write(dimension+","+generation + "," + formatter.format(avgFitness) + "," + formatter.format(bestFitness) + "\n");
	}
